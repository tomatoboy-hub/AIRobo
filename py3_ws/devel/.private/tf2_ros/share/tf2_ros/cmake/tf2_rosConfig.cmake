...
if("TRUE" STREQUAL "TRUE")
  set(tf2_ros_SOURCE_PREFIX /workspace/py3_ws/src/third-party/geometry2/tf2_ros)
  set(tf2_ros_DEVEL_PREFIX /workspace/py3_ws/devel/.private/tf2_ros)
  set(tf2_ros_INSTALL_PREFIX "")
  set(tf2_ros_PREFIX ${tf2_ros_DEVEL_PREFIX})
else()
  set(tf2_ros_SOURCE_PREFIX "")
  set(tf2_ros_DEVEL_PREFIX "")
  set(tf2_ros_INSTALL_PREFIX /workspace/py3_ws/install)
...
if(NOT "/workspace/py3_ws/src/third-party/geometry2/tf2_ros/include " STREQUAL " ")
  set(tf2_ros_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/py3_ws/src/third-party/geometry2/tf2_ros/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/py3_ws/src/third-party/geometry2/tf2_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/py3_ws/devel/.private/tf2_ros/lib;/workspace/py3_ws/devel/lib;/opt/ros/melodic/lib)
