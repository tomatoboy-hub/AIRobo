...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /workspace/py3_ws/src/third-party/geometry2/tf2)
  set(tf2_DEVEL_PREFIX /workspace/py3_ws/devel/.private/tf2)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /workspace/py3_ws/install)
...
if(NOT "/workspace/py3_ws/src/third-party/geometry2/tf2/include;/usr/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/py3_ws/src/third-party/geometry2/tf2/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/py3_ws/src/third-party/geometry2/tf2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/py3_ws/devel/.private/tf2/lib;/workspace/py3_ws/devel/lib;/opt/ros/melodic/lib)
