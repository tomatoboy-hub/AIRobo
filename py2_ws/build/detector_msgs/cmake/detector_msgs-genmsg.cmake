...
set(MSG_I_FLAGS "-Idetector_msgs:/workspace/py2_ws/src/detector_msgs/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/workspace/py2_ws/src/detector_msgs/srv/AddTransformToManager.srv" NAME_WE)
add_custom_target(_detector_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "detector_msgs" "/workspace/py2_ws/src/detector_msgs/srv/AddTransformToManager.srv" "geometry_msgs/Vector3:geometry_msgs/TransformStamped:geometry_msgs/Transform:geometry_msgs/Quaternion:std_msgs/Header"
)

get_filename_component(_filename "/workspace/py2_ws/src/detector_msgs/srv/GetObjectDetection.srv" NAME_WE)
add_custom_target(_detector_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "detector_msgs" "/workspace/py2_ws/src/detector_msgs/srv/GetObjectDetection.srv" "detector_msgs/BBox:detector_msgs/BBoxArray:std_msgs/Header"
)

get_filename_component(_filename "/workspace/py2_ws/src/detector_msgs/srv/SetTransformFromBBox.srv" NAME_WE)
add_custom_target(_detector_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "detector_msgs" "/workspace/py2_ws/src/detector_msgs/srv/SetTransformFromBBox.srv" "detector_msgs/BBox"
)

get_filename_component(_filename "/workspace/py2_ws/src/detector_msgs/msg/BBoxArray.msg" NAME_WE)
add_custom_target(_detector_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "detector_msgs" "/workspace/py2_ws/src/detector_msgs/msg/BBoxArray.msg" "detector_msgs/BBox:std_msgs/Header"
)

get_filename_component(_filename "/workspace/py2_ws/src/detector_msgs/msg/BBox.msg" NAME_WE)
add_custom_target(_detector_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "detector_msgs" "/workspace/py2_ws/src/detector_msgs/msg/BBox.msg" ""
)
...
_generate_msg_cpp(detector_msgs
  ...
  "${MSG_I_FLAGS}"
  "/workspace/py2_ws/src/detector_msgs/msg/BBox.msg;/opt/ros/melodic/share/std_msgs/cmake/../msg/Header.msg"
...
_generate_srv_cpp(detector_msgs
  ...
  "${MSG_I_FLAGS}"
  "/workspace/py2_ws/src/detector_msgs/msg/BBox.msg;/workspace/py2_ws/src/detector_msgs/msg/BBoxArray.msg;/opt/ros/melodic/share/std_msgs/cmake/../msg/Header.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/detector_msgs
)
_generate_srv_cpp(detector_msgs
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detector_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detector_msgs\")")
  # install generated code
  install(
